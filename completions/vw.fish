...
complete --command vw --long-option alpha --description 'alpha: mutiplicative constant for indentiy' --no-files  --require-parameter
...
complete --command vw --long-option bandwidth --description 'bandwidth: bandwidth of rbf kernel' --no-files  --require-parameter
complete --command vw --long-option baseline --description 'baseline: Learn an additive baseline (from constant features) and a residual separately in regression.' --no-files
...
complete --command vw --long-option bfgs --description 'bfgs: Option not supported by this reduction' --no-files
...
complete --command vw --long-option cats --description 'cats: number of discrete actions <k> for cats' --no-files  --require-parameter
...
complete --command vw --long-option cb --description 'cb: Use contextual bandit learning with <k> costs' --no-files  --require-parameter
...
complete --command vw --long-option cb_explore --description 'cb_explore: Online explore-exploit for a <k> action contextual bandit problem' --no-files  --require-parameter
...
complete --command vw --long-option cb_force_legacy --description 'cb_force_legacy: Default to non-adf cb implementation (cb_to_cb_adf)' --no-files
complete --command vw --long-option cb_max_cost --description 'cb_max_cost: upper bound on cost' --no-files  --require-parameter
complete --command vw --long-option cb_min_cost --description 'cb_min_cost: lower bound on cost' --no-files  --require-parameter
...
complete --command vw --long-option cb_type --description 'cb_type: contextual bandit method to use in {ips,dm,dr}' --no-files  --require-parameter --arguments "ips dm dr mtr sm"
complete --command vw --long-option cbify --description 'cbify: Convert multiclass on <k> classes into a contextual bandit problem' --no-files  --require-parameter
...
complete --command vw --long-option conjugate_gradient --description 'conjugate_gradient: Option not supported by this reduction' --no-files
...
complete --command vw --long-option cover --description 'cover: cover size. Default 12.' --no-files  --require-parameter
...
complete --command vw --long-option first_only --description 'first_only: Only explore the first action in a tie-breaking event' --no-files
...
complete --command vw --long-option mellowness --description 'mellowness: active learning mellowness parameter c_0. Default 8' --no-files  --require-parameter
...
complete --command vw --long-option onethread --description 'onethread: Disable parse thread' --no-files
...
complete --command vw --long-option simulation --description 'simulation: active learning simulation mode' --no-files
